<?php
namespace AHT\GiftCard\Model\ResourceModel\GiftCardHistory;
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    protected $_idFieldName = 'history_id';
    protected $_eventPrefix = 'aht_giftcard_gift_card_history_collection';
    protected $_eventObject = 'gift_card_history_collection';
    protected function _construct()
    {
        $this->_init('AHT\GiftCard\Model\GiftCardHistory', 'AHT\GiftCard\Model\ResourceModel\GiftCardHistory');
    }
    // public function a()
    // {
